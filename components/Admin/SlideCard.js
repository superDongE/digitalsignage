    ...
    return (
      <div className='card'>
        ...
        <div className='left'>
          ...
          >
          {value.type == 'photo' && (
            <FontAwesomeIcon icon={faInstagram} fixedWidth size='lg' color='#FFFFFF'
             />
          )}
          {value.type == 'video' && (
            <FontAwesomeIcon icon={faPlay} fixedWidth size='1g' color='#FFFFFF' />
          )}
            {value.type == 'youtube' && (
        ...
        <div className='middle'>
          <div className='title'>{value.title ? value.title : '제목 없음'}</div>
